...
public interface ZVModel {
     ...
     *
     * @param nodes - paths the nodes to be deleted
     */
     ...
     *
     * @param path the node path
     * @return the {@link ZVNode} instance, or <code>null</code> if the node
     * doesn't exist
     */
     ...
     * @return the list of child nodes, or an empty list if parent has no
     * children
     */
